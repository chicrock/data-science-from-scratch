...
from ch04_linear_algebra import shape, get_row, get_column, make_matrix, \
    vector_mean, vector_sum, dot, magnitude, vector_subtract, scalar_multiply
from ch05_statistics import correlation, standard_deviation, mean
from ch06_probability import inverse_normal_cdf
from ch08_gradient_descent import maximize_batch
